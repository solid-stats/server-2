...
- **Global scope**: `/home/afgan0r/Projects/SolidGames/server-2/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/afgan0r/Projects/SolidGames/server-2/.claude/notes/`)
...
2. Glob `/home/afgan0r/Projects/SolidGames/server-2/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/afgan0r/Projects/SolidGames/server-2/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/afgan0r/Projects/SolidGames/server-2/.claude/notes/` — works in any directory
