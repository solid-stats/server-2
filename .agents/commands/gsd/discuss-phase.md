...
Read and execute `/home/afgan0r/Projects/SolidGames/server-2/.claude/gsd-core/workflows/list-phase-assumptions.md` end-to-end.
Stop here.

Otherwise, if `DISCUSS_MODE` is `"assumptions"`:
Read and execute `/home/afgan0r/Projects/SolidGames/server-2/.claude/gsd-core/workflows/discuss-phase-assumptions.md` end-to-end.

Otherwise (`"discuss"` / unset / any other value):
Read and execute `/home/afgan0r/Projects/SolidGames/server-2/.claude/gsd-core/workflows/discuss-phase.md` end-to-end.
