...
**CJS-only (graphify):** `graphify` subcommands are not registered on `gsd-tools query`. Use `node /home/afgan0r/Projects/SolidGames/server-2/.claude/gsd-core/bin/gsd-tools.cjs graphify …` as documented in this command and in `docs/CLI-TOOLS.md`. Other tooling may still use `gsd-tools query` where a handler exists.
...
Knowledge graph is disabled. To activate:
  ...
  node /home/afgan0r/Projects/SolidGames/server-2/.claude/gsd-core/bin/gsd-tools.cjs config-set graphify.enabled true
