...
**Plans**: 6 plans
- [ ] 16-01-PLAN.md — Pure helpers: slugify/looksLikeUuid/shortSuffix + withGaps + maxTimestamp with Wave-0 unit tests (Wave 1)
- [ ] 16-02-PLAN.md — Shared migration 0006: slug column + partial-unique/btree indexes + slug_base() + deterministic backfill on 4 tables (Wave 1)
...
| 16. Slug Resolution, History & Provenance | v3.0 | 0/6 | Planned | - |
